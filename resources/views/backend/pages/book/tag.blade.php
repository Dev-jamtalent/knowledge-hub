                            ...
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    <form class="simple-example" action="javascript:void(0);" novalidate>
                                        ...
                                        <button class="btn btn-primary submit-fn mt-2" id="addBtn" onclick="addData()" type="submit">Add Tag</button>
                                    </form>
	...
	function clearData(){
     ...
     function allData() {
        $.ajax({
          type: "GET",
          dataType: "json",
          url: "/user/book/tag/all",
          success:function (response) {
            var data = "";
            $.each(response, function(key,value){
              data = data + "<tr>"
              data = data + "<td>" +value.book_tag_name+ "</td>"
              data = data + "<td>"
