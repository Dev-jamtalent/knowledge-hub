                                            ...
                                            <form class="simple-example"  method="post" id="upload_form" enctype="multipart/form-data" novalidate>
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-12 mb-4">
                                                        ...
                                                        <input type="text" readonly class="form-control" value="{{$channel->name}}" placeholder="" value="" required>
        ...
        $.ajax({
          ...
          success:function (response) {
            ...
            $.each(response, function(key,value){
              ...
              data = data + "<tr>"
              data = data + "<td>" +value.video.title+ "</td>"
