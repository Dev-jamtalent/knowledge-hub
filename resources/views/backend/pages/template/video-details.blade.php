@extends("backend.layouts.backend")
		...
		@section("style")
		<link href="{{ asset('backend') }}/assets/plugins/OwlCarousel/css/owl.carousel.min.css" rel="stylesheet" />
		@endsection
					  ...
					  <div class="col-md-4 border-end">
						<div class="image-zoom-section">
							<div class="product-gallery owl-carousel owl-theme border mb-3 p-3" data-slider-id="1">
								<div class="item">
									<img src="{{ asset('backend') }}/assets/images/products/11.png" class="img-fluid" alt="">
								</div>
								<div class="item">
									<img src="{{ asset('backend') }}/assets/images/products/12.png" class="img-fluid" alt="">
								</div>
								<div class="item">
									<img src="{{ asset('backend') }}/assets/images/products/13.png" class="img-fluid" alt="">
								</div>
								<div class="item">
									<img src="{{ asset('backend') }}/assets/images/products/14.png" class="img-fluid" alt="">
								</div>
							</div>
							<div class="owl-thumbs d-flex justify-content-center" data-slider-id="1">
								<button class="owl-thumb-item">
									<img src="{{ asset('backend') }}/assets/images/products/11.png" class="" alt="">
								</button>
								<button class="owl-thumb-item">
									<img src="{{ asset('backend') }}/assets/images/products/12.png" class="" alt="">
								</button>
								<button class="owl-thumb-item">
									<img src="{{ asset('backend') }}/assets/images/products/13.png" class="" alt="">
								</button>
								<button class="owl-thumb-item">
									<img src="{{ asset('backend') }}/assets/images/products/14.png" class="" alt="">
								</button>
							</div>
						</div>
					  </div>
		...
		@endsection
		@section("script")
		<script src="{{ asset('backend') }}/assets/plugins/OwlCarousel/js/owl.carousel.min.js"></script>
		<script src="{{ asset('backend') }}/assets/plugins/OwlCarousel/js/owl.carousel2.thumbs.min.js"></script>
