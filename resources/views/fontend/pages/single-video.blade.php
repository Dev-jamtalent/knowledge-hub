...
@php
$instructor = App\Models\Instructor::where('id',$video->instructor_id)->first();
$videoCount = App\Models\Video::where('id',$video->instructor_id)->count();
@endphp
    ...
    <div class="container">
        <div class="row">
                ...
                <div class="info">
                    <div class="custom-tabs">
                        <div class="tabs-panel">
                            ...
                            <a href="{{route('video.download',$video->slug)}}" data-tab="tab-3">
                        ...
                        <div class="tabs-content">
                            ...
                            <div class="tab-3">
                                ...
                                <div class="tags-type2">
                                    <a href="{{route('video.download',$video->slug)}}"><i class="fa fa-long-arrow-down" aria-hidden="true"></i>PDF</a>
                                ...
                                <div class="col-lg-3 col-sm-6 col-xs-12">
                                    <div class="h-video row">
                                        <div class="col-sm-12 col-xs-6">
                                            <div class="v-img">
                                                <a href="{{route('home.video.details',$insvideo->slug)}}"><img src="{{asset($insvideo->image)}}" alt=""></a>
                                                
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-xs-6">
                                            <div class="v-desc">
                                                <a href="{{route('home.video.details',$insvideo->slug)}}">{{$insvideo->title}}</a>
                                            </div>
                                            <div class="v-views">
                                                Free
                                            </div>
            ...
            <div class="col-lg-4 col-xs-12 col-sm-12 hidden-xs">
                ...
                <div class="list">
                    @forelse(App\Models\Video::where('instructor_id',$video->instructor_id)->where('id', '!=' ,$video->id)->get() as $insvideo)
                    <div class="h-video row">
                ...
                <div class="list">
                    @forelse(App\Models\Video::where('title', 'LIKE' ,$video->title)->orWhere('id', 'LIKE' ,$video->id)->where('id', '!=' ,$video->id)->get()->take(10) as $insvideo)
                    <div class="h-video row">
                        <div class="col-lg-6 col-sm-6">
                            <div class="v-img">
                                <a href="{{route('home.video.details',$insvideo->slug)}}"><img src="{{asset($insvideo->image)}}" alt=""></a>
